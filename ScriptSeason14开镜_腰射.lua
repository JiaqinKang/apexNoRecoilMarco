...
if (event == "PROFILE_ACTIVATED") then
	...
	dofile("C:/Users/Public/Downloads/thermit.lua")
	dofile("C:/Users/Public/Downloads/turbo.lua")
	...
	local datetimenow = GetDate("%y%m%d%H");
...
function guntogo(qx)
	...
	if (event == "MOUSE_BUTTON_PRESSED" and arg == a1) then
		...
		if hwk_state == 1 and offset_state == "HWK" then	Sleep(325)	end
...
function click()
	...
	repeat
		...
		if(ij<=listLen) then
			...
			if(offset_state == "P20" or offset_state == "Y_P20" or offset_state == "HMLK_DD" or offset_state == "XBS" or offset_state == "R301DD" or offset_state == "PXDD" or offset_state == "G7" or (LS_5LianFa == 1 and (offset_state == "LS" or offset_state == "Y_LS"))) then PressAndReleaseMouseButton(1) end
